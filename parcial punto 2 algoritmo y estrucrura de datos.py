...
print (f"Cantidad de especies: {numero_especies}")
   ...
   # determinar cuántos descubridores hay
descubridores = set(dino["descubridor"] for dino in dinosaurios)
numero_descubridores = len(descubridores)
print(f"Cantidad de descubridores distintos:{numero_descubridores}")


#  dinosaurios que empiecen con la T
dinosaurios_con_T = [dino for dino in dinosaurios if dino["nombre"].startswith("T")]
...
dinosaurios_ligeros =  [dino for dino in dinosaurios if int(dino["peso"].split()[0]) < 275]
print ("Dinosaurios que pesan menos de 275 kg:")
for dino in dinosaurios_ligeros:
    print (dino["nombre"])

#  pila de todos los dinosaurios que comienzan con A, Q, S
dinosaurios_A_Q_S = [dino for dino in dinosaurios if dino["nombre"][0] in "AQS"]
print("Dinosaurios que comienzan con A, Q, S:")
for dino in dinosaurios_A_Q_S:
    print(dino["nombre"])
